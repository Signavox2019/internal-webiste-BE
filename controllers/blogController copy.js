...
exports.updateBlog = asyncHandler(async (req, res) => {
  ...
  if (req.file) {
    updates.coverImage = `/uploads/blogs/${req.file.filename}`;
  }
...
// ✅ Blog Stats (total, published, draft, by category)
...
// ✅ Monthly Stats (blogs published per month in current year)
...
// ✅ Yearly Stats (blogs published per year)
